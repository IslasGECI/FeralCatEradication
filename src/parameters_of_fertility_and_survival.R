...
fy_m_sd < -mean(
    c(((0.745 - 0.352) / 2), ((1.58 - 0.745) / 2))
)  # Mean and standard deviations, juvenile fertility
a_m_sd < -mean(
    c(((2.52 - 1.98) / 2), ((3.78 - 2.52) / 2))
)  # Mean and standard deviations, adult fertility
...
y1_2_s_sd < -mean(
    c(((0.46 - 0.27) / 2), ((0.73 - 0.46) / 2))
)  # mean and standard deviations, juvenile survival
a_s_sd < -mean(
    c(((0.7 - 0.55) / 2), ((0.78 - 0.7) / 2))
)  # mean and standard deviations, adult survival
